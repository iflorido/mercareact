    ...
    <>
      <div className="container-app" style={{ padding: '1.5rem 1.25rem 3rem' }}>
        ...
        <div className="detail-grid">
          ...
          <div>
            ...
            <h1 style={{ fontSize: 'clamp(1.2rem, 2.5vw, 1.6rem)', marginBottom: '0.5rem' }}>{product.display_name}</h1>
            <p style={{ color: 'var(--text-2)', fontSize: '0.88rem', marginBottom: '1.5rem' }}>{product.details?.legal_name}</p>
            ...
            <div className="accordion" id="productAccordion">
              {product.nutrition_information?.ingredients && (
                <div className="accordion-item">
                  <h2 className="accordion-header"><button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseIng"><strong>Ingredientes</strong></button></h2>
      ...
      {showToast && (
        <div className="toast-custom">
          <i className="bi bi-check-circle-fill"></i> {toastMsg}
        </div>
      )}
    </>
  );
